...
#ifndef SIMULATION_PATHDRAWER_TASK_HPP
...
namespace mars {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','mars::PathDrawer')
     end
     \endverbatim
    ...
    public:
         ...
         */
        PathDrawer(std::string const& name = "mars::PathDrawer");
         ...
         * 
         */
        PathDrawer(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of PathDrawer
         */
	~PathDrawer();
